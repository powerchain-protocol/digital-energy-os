...
const items=[{label:"Profile overview",href:"/settings"},{label:"Company",href:"/settings/company"},{label:"Users & roles",href:"/settings/users"},{label:"Organization",href:"/settings/organization"},{label:"Themes",href:"/settings/themes"},{label:"PWRC / Credits",href:"/settings/credits"}];
