...
export const EMS_MODULES=["energy-monitoring","smart-metering","device-management","local-energy","billing","settlement","forecasting","renewables","rewards","treasury"] as const;
