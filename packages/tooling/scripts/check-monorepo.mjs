...
const required=["apps/web","apps/api","apps/ai-gateway","apps/integration-gateway","apps/websocket-gateway","apps/workers","apps/marketplace","apps/checkout","apps/explorer","apps/ems","packages/control-plane","packages/asset-graph","packages/device-control","packages/revenue-engine","packages/token-framework","packages/ems","packages/local-energy","packages/energy-network","packages/widgets","packages/charts","packages/wallets","packages/tokens","packages/transactions","packages/rpc","packages/websocket","packages/pvm","packages/integration"];
