...
export const certificationPrograms: CertificationProgram[] = [
 ...
 {id:"program-crt",slug:"carbon-credit-token",name:"Carbon Credit Token",kind:"CCT",authority:"PowerChain Carbon Registry",standard:"PTSP-400",status:"active",jurisdictions:["Global"],validForDays:3650,requirements:["Verified methodology","Independent audit","Retirement controls"]},
...
export const tokenizedCertificates: TokenizedCertificate[] = [
 ...
 {id:"CCT-BR-2025-00008314",programId:"program-crt",kind:"CCT",ownerId:"org-demo",assetId:"amazon-reforest-44",quantity:"1250",unit:"tCO2e",vintage:2025,status:"verified",issuedAt:"2026-07-15T10:30:00Z",blockchain:"sui",proofHash:"sha256:crt8314"}
];
