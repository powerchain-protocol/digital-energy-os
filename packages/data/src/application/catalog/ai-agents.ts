...
{id:"tokenomics-analyst",name:"Tokenomics Analyst",domain:"tokenomics",description:"Analyzes PWRC, wPWRC, CCT, fees, supply and market assumptions.",skills:["token-pricing","supply-analysis","bridge-invariant"],modelId:"tokenomics-lora",requiresApproval:false},
