...
test("transaction API and Cetus adapter are present", async () => {
  const route = await readFile(new URL("../src/app/api/v1/transactions/route.ts", import.meta.url), "utf8");
  const cetus = await readFile(new URL("../src/lib/integrations/cetus/cetus.ts", import.meta.url), "utf8");
