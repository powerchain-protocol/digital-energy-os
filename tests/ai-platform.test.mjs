...
test('AI routes and quote API exist',()=>{for(const p of['src/app/dashboard/ai/page.tsx','src/app/dashboard/ai/chat/page.tsx','src/app/api/v1/ai/quote/route.ts','src/app/api/v1/ai/providers/route.ts'])assert.ok(fs.existsSync(p),p)});
