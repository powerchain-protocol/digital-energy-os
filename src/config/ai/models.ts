...
{id:"tokenomics-lora",name:"Tokenomics LoRA",kind:"lora",provider:"PowerChain",purpose:"PWRC, wPWRC, CCT, REC, fees and treasury analysis",contextWindow:64000,enabled:true},
