      ...
      <div className="content-container space-y-5">
        <section className="rounded-[26px] bg-gradient-to-br from-[#073f31] via-[#0b5844] to-[#083d31] p-6 text-white shadow-[0_22px_70px_rgba(7,63,49,.22)] sm:p-8">
          <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div className="flex flex-wrap gap-3"><Link href="/docs/certification"><Button variant="white">Requirements</Button></Link><Link href="/carbon"><Button variant="framed" className="border-white/30 text-white hover:bg-white/10">Carbon Exchange</Button></Link></div>
          </div>
        </section>
        ...
        <section className="rounded-[22px] border border-[var(--border)] bg-[var(--surface)] p-5 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3"><div><p className="text-xs font-semibold uppercase tracking-[.15em] text-emerald-700">Registry</p><h2 className="mt-1 text-xl font-semibold">Tokenized certificates</h2></div><Link href="/tokens/cct"><Button variant="framed">View token details</Button></Link></div>
