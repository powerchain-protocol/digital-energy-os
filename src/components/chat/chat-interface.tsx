...
const MAX = 2000;
const allowed = /energy|renewable|solar|wind|hydro|battery|grid|meter|iot|depin|carbon|token|pwrc|cct|rec|market|price|treasury|asset|ev|charging|forecast|maintenance|settlement/i;
