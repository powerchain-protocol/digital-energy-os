...
const assetSources: Record<PowerChainAssetSymbol, string[]> = {
  PWRC: ["/PWRC.png", "/assets/tokens/pwrc.png"],
  CCT: ["/CCT.png", "/assets/tokens/cct.png"],
...
const labels: Record<PowerChainAssetSymbol, string> = { PWRC: "PW", CCT: "CC", SOL: "SOL", SUI: "SUI", USDC: "$" };
