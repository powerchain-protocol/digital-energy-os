"use client";
import { Bell, Bot, Menu, Moon, Search, Sun } from "lucide-react";
...
export function Header(){
 const {theme,toggle}=useTheme(); const {session}=useAuth(); const {setMobileSidebarOpen,setCommandOpen}=useApp(); const meta=usePageMeta(); const {currency,setCurrency,distanceUnit,setDistanceUnit}=usePreferences();
